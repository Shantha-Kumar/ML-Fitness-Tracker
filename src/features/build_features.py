...
# ------------------ To avoid the mixing of data from one label to other because of window size
df_temporal_list = []
...
subset[["acc_y"]].plot()
subset[[
    'acc_y_max_freq', 'acc_y_freq_weighted',
    'acc_y_pse', 'acc_y_freq_0.0_Hz_ws_14',
...
cluster_columns = ["acc_x", "acc_r", "acc_z"]
k_values = range(2, 10)
inertia = []
